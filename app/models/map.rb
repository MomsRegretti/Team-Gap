class Map < ApplicationRecord    
    ...
    def addagents
        ...
        if m1.displayName == "Ascent"
            ...
            Mapagent.create(map_id: m1.id, agent_id: 20, rating: "Strong") #jett
            Mapagent.create(map_id: m1.id, agent_id: 5, rating: "Generally Good") #kayo
            Mapagent.create(map_id: m1.id, agent_id: 19, rating: "Generally Good") #omen
            ...
            Mapagent.create(map_id: m1.id, agent_id: 11, rating: "Weak") #viper
            ...
            Mapagent.create(map_id: m1.id, agent_id: 20, rating: "Generally Good")
            Mapagent.create(map_id: m1.id, agent_id: 4, rating: "Generally Good")
            Mapagent.create(map_id: m1.id, agent_id: 3, rating: "Weak")
            Mapagent.create(map_id: m1.id, agent_id: 11, rating: "Weak")
        elsif m1.displayName == "Bind"
            m1.update!(rolebias: "Controller")
            Mapagent.create(map_id: m1.id, agent_id: 11, rating: "Strong") 
            Mapagent.create(map_id: m1.id, agent_id: 17, rating: "Strong") #Sage
            Mapagent.create(map_id: m1.id, agent_id: 3, rating: "Strong") 
            Mapagent.create(map_id: m1.id, agent_id: 14, rating: "Generally Good") #brimstone
            Mapagent.create(map_id: m1.id, agent_id: 4, rating: "Generally Good") 
            Mapagent.create(map_id: m1.id, agent_id: 19, rating: "Weak") 
            Mapagent.create(map_id: m1.id, agent_id: 20, rating: "Weak")
        elsif m1.displayName == "Split"
            m1.update!(rolebias: "Initiator")
            Mapagent.create(map_id: m1.id, agent_id: 3, rating: "Strong") 
            Mapagent.create(map_id: m1.id, agent_id: 6, rating: "Strong") 
            Mapagent.create(map_id: m1.id, agent_id: 13, rating: "Strong") #Astra
            Mapagent.create(map_id: m1.id, agent_id: 19, rating: "Generally Good") 
            Mapagent.create(map_id: m1.id, agent_id: 4, rating: "Generally Good") 
            Mapagent.create(map_id: m1.id, agent_id: 17, rating: "Generally Good") 
            Mapagent.create(map_id: m1.id, agent_id: 8, rating: "Weak") 
            Mapagent.create(map_id: m1.id, agent_id: 14, rating: "Weak") 
            Mapagent.create(map_id: m1.id, agent_id: 5, rating: "Weak")
        elsif m1.displayName == "Breeze"
            m1.update!(rolebias: "Initiator")
            Mapagent.create(map_id: m1.id, agent_id: 11, rating: "Strong") 
            Mapagent.create(map_id: m1.id, agent_id: 20, rating: "Strong") 
            Mapagent.create(map_id: m1.id, agent_id: 8, rating: "Strong") 
            Mapagent.create(map_id: m1.id, agent_id: 4, rating: "Generally Good") 
            ...
            Mapagent.create(map_id: m1.id, agent_id: 11, rating: "Strong") 
            Mapagent.create(map_id: m1.id, agent_id: 18, rating: "Strong") 
            Mapagent.create(map_id: m1.id, agent_id: 4, rating: "Generally Good") 
            ...
            Mapagent.create(map_id: m1.id, agent_id: 14, rating: "Generally Good") 
            Mapagent.create(map_id: m1.id, agent_id: 4, rating: "Generally Good") 
