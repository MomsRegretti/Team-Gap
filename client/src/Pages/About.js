    ...
    <div className="page-container" style={{ margin: "5% auto", height: "70vh", width: "50%" }}>
      <div style={{ width: "80%", margin: "auto" }}>
        ...
        <div style={{ display: "grid", height: "auto", width: "100%" }}>
          <p style={{ textAlign: "center", placeSelf: "center" }}>Team Canyon is my final project for the Software Engineering Program at Flatiron School. It was made using React for the front-end and Ruby on Rails for the back-end.</p>
